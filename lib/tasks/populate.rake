namespace :db do
  ...
  task :populate => :environment do
    ...
    run1.expected_duration = Time.now + 60*60*2
    ...
    run2.expected_duration = Time.now + 60*60*3.5
    ...
    run3.expected_duration = Time.now + 60*60*3.5
    ...
    run4.expected_duration = Time.now + 60*60*-4
    ...
    run5.expected_duration = Time.now + 60*60*5.40
    ...
    run6.expected_duration = Time.now + 60*60*5.40
